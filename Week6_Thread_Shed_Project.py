...
#print(daily_sales_replaced)  # Edith Mcbride   ||$1.21   ||   white || 09/15/17   ,


daily_transactions = daily_sales_replaced.split(",")
#print(daily_transactions)  # 'Edith Mcbride   ||$1.21   ||   white || \n09/15/17   ',
...
#print(total_sales)  # Prints 1498.74
...
for thread in thread_sold:
    temp_thread = []
    if "&" in thread:
        temp_thread = thread.split("&")
        for sub_thread in temp_thread:
            thread_sold_split.append(sub_thread)
    else:
...
def color_count(color):
    ...
    for i in thread_sold_split:
        if i == color:
            count += 1
    return print("Thread Shed sold {} threads of \"{}\" thread today.".format(count, color))
